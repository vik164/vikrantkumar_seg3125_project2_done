...
const VehiclesPage = () => {
    ...
    const handleButton = (event) => {
        if(filter == 1){
            ...
            window.location.href = "/vikrantkumar_seg3125_project2_done/#/Vehicles_2";
        }
    }
    window.scrollTo(0, 0);
                ...
                <Row md={true} style={{marginTop:15, marginBottom:15}}>
                    <Col md={true} className='d-flex align-items-center justify-content-center'>
                        <Card style={{width: '25rem', height:'22rem'}} text='light' bg='dark'>
                            ...
                            <Button size='md' style={{marginTop:4}} href="/vikrantkumar_seg3125_project2_done/#/Vehicle7"> Learn More</Button>
                        </Card>
                    </Col>
                    <Col md={true} className='d-flex align-items-center justify-content-center'>
                        <Card style={{width: '25rem', height:'22rem'}} text='light' bg='dark'>
                            ...
                            <Button size='md' style={{marginTop:4}} href="/vikrantkumar_seg3125_project2_done/#/Vehicle8"> Learn More</Button>
                        </Card>
                    </Col>
                    <Col md={true} className='d-flex align-items-center justify-content-center'>
                    <Card style={{width: '25rem', height:'22rem'}} text='light' bg='dark'>
                            ...
                            <Button size='md' style={{marginTop:4}} href="/vikrantkumar_seg3125_project2_done/#/Vehicle9"> Learn More</Button>
                        </Card>
                    </Col>
                </Row>
                <hr></hr>
